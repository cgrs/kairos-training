describe('App', () => {
  ...
  describe('left button', () => {
    it('should send text to left area', () => {
      leftButton.click();
      expect(leftArea.value).toEqual('Testing456 from right\nTesting123 from left');
    });
  });
  describe('right button', () => {
    it('should send text to right area', () => {
      rightButton.click();
      expect(rightArea.value).toEqual('Testing123 from left\nTesting456 from right');
    });
  });
  describe('swap button', () => {
    ...
    let rightContent;
    beforeEach(() => {
      leftContent = { before: leftArea.value };
      rightContent = { before: rightArea.value };
    });
